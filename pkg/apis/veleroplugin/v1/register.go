...
// GroupName is the group name for the Velero Plugin API
const GroupName = "veleroplugin.io"

// SchemeGroupVersion is the GroupVersion for the Velero Plugin API
...
// CustomResources returns a map of all custom resources within the Velero Plugin
