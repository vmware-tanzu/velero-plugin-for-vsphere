...
var deletesnapshotsResource = schema.GroupVersionResource{Group: "backupdriver.io", Version: "v1", Resource: "deletesnapshots"}
...
func (c *FakeDeleteSnapshots) Get(name string, options v1.GetOptions) (result *backupdriverv1.DeleteSnapshot, err error) {
	...
	return obj.(*backupdriverv1.DeleteSnapshot), err
}
...
func (c *FakeDeleteSnapshots) List(opts v1.ListOptions) (result *backupdriverv1.DeleteSnapshotList, err error) {
	...
	list := &backupdriverv1.DeleteSnapshotList{ListMeta: obj.(*backupdriverv1.DeleteSnapshotList).ListMeta}
	for _, item := range obj.(*backupdriverv1.DeleteSnapshotList).Items {
