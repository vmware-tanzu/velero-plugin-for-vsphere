...
type VeleropluginV1Interface interface {
...
func NewForConfig(c *rest.Config) (*VeleropluginV1Client, error) {
	...
	return &VeleropluginV1Client{client}, nil
}

// NewForConfigOrDie creates a new VeleropluginV1Client for the given config and
