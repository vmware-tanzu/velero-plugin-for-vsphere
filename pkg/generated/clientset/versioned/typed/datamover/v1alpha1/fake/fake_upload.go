...
var uploadsResource = schema.GroupVersionResource{Group: "datamover.cnsdp.vmware.com", Version: "v1alpha1", Resource: "uploads"}

var uploadsKind = schema.GroupVersionKind{Group: "datamover.cnsdp.vmware.com", Version: "v1alpha1", Kind: "Upload"}
...
func (c *FakeUploads) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Upload, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(uploadsResource, c.ns, name), &v1alpha1.Upload{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Upload), err
}
...
func (c *FakeUploads) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UploadList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(uploadsResource, uploadsKind, c.ns, opts), &v1alpha1.UploadList{})
	...
	list := &v1alpha1.UploadList{ListMeta: obj.(*v1alpha1.UploadList).ListMeta}
	for _, item := range obj.(*v1alpha1.UploadList).Items {
...
func (c *FakeUploads) Create(ctx context.Context, upload *v1alpha1.Upload, opts v1.CreateOptions) (result *v1alpha1.Upload, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(uploadsResource, c.ns, upload), &v1alpha1.Upload{})
...
func (c *FakeUploads) Update(ctx context.Context, upload *v1alpha1.Upload, opts v1.UpdateOptions) (result *v1alpha1.Upload, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(uploadsResource, c.ns, upload), &v1alpha1.Upload{})
...
func (c *FakeUploads) UpdateStatus(ctx context.Context, upload *v1alpha1.Upload, opts v1.UpdateOptions) (*v1alpha1.Upload, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(uploadsResource, "status", c.ns, upload), &v1alpha1.Upload{})
...
func (c *FakeUploads) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(uploadsResource, c.ns, name), &v1alpha1.Upload{})
...
func (c *FakeUploads) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.UploadList{})
	return err
}
...
func (c *FakeUploads) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Upload, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(uploadsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Upload{})
