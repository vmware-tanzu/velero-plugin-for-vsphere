...
var downloadsResource = schema.GroupVersionResource{Group: "datamover.cnsdp.vmware.com", Version: "v1alpha1", Resource: "downloads"}

var downloadsKind = schema.GroupVersionKind{Group: "datamover.cnsdp.vmware.com", Version: "v1alpha1", Kind: "Download"}
...
func (c *FakeDownloads) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Download, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(downloadsResource, c.ns, name), &v1alpha1.Download{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Download), err
}
...
func (c *FakeDownloads) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DownloadList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(downloadsResource, downloadsKind, c.ns, opts), &v1alpha1.DownloadList{})
	...
	list := &v1alpha1.DownloadList{ListMeta: obj.(*v1alpha1.DownloadList).ListMeta}
	for _, item := range obj.(*v1alpha1.DownloadList).Items {
...
func (c *FakeDownloads) Create(ctx context.Context, download *v1alpha1.Download, opts v1.CreateOptions) (result *v1alpha1.Download, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(downloadsResource, c.ns, download), &v1alpha1.Download{})
...
func (c *FakeDownloads) Update(ctx context.Context, download *v1alpha1.Download, opts v1.UpdateOptions) (result *v1alpha1.Download, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(downloadsResource, c.ns, download), &v1alpha1.Download{})
...
func (c *FakeDownloads) UpdateStatus(ctx context.Context, download *v1alpha1.Download, opts v1.UpdateOptions) (*v1alpha1.Download, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(downloadsResource, "status", c.ns, download), &v1alpha1.Download{})
...
func (c *FakeDownloads) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(downloadsResource, c.ns, name), &v1alpha1.Download{})
...
func (c *FakeDownloads) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.DownloadList{})
	return err
}
...
func (c *FakeDownloads) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Download, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(downloadsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Download{})
