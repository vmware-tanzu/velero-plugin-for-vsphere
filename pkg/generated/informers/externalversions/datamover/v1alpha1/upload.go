	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DatamoverV1alpha1().Uploads(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatamoverV1alpha1().Uploads(namespace).Watch(context.TODO(), options)
			},
		},
		&datamoverv1alpha1.Upload{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *uploadInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&datamoverv1alpha1.Upload{}, f.defaultInformer)
}

func (f *uploadInformer) Lister() v1alpha1.UploadLister {
	return v1alpha1.NewUploadLister(f.Informer().GetIndexer())
}
