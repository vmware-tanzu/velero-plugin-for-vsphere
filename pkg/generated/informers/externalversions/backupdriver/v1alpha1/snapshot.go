	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BackupdriverV1alpha1().Snapshots(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BackupdriverV1alpha1().Snapshots(namespace).Watch(context.TODO(), options)
			},
		},
		&backupdriverv1alpha1.Snapshot{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *snapshotInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backupdriverv1alpha1.Snapshot{}, f.defaultInformer)
}
