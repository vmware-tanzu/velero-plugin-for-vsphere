...
func (f *downloadInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&veleropluginv1.Download{}, f.defaultInformer)
}

func (f *downloadInformer) Lister() v1.DownloadLister {
	return v1.NewDownloadLister(f.Informer().GetIndexer())
}
